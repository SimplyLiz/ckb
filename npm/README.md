...
CKB exposes 111 tools, but most sessions only need a subset. Use presets to reduce token overhead by up to 83%:
...
ckb mcp --preset=full        # 111 tools - all tools (legacy)
```
